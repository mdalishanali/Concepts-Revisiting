/* 
    ...
    Given an array A having N positive integers. Count the number of non-empty subsets of 
    array A such that each subset has at least K odd numbers.
...
function kOddSubset(arr, K) {
    ...
    function getSubset(arr, newArr, curr) {
        ...
        getSubset(arr, newArr.push([arr[curr]]), curr + 1);
    }
    getSubset(arr, [], 0);
    console.log(count);
}
